...
import mp.amir.ir.kamandnet.utils.general.getBitmapFromVectorDrawable
...
class InstructionActivity : AppCompatActivity(), QRorNFCDialog.Interactions {
    ...
    private fun initViews() {
        mBinding.ivBack.setOnClickListener {
            //TODO age taghiri ijad karde bud alert biad bege motmaeni ya na
            finish()
        }

        mBinding.frameAddPic.setOnClickListener {
            //TODO intent to camera
            //TODO THIS IS FAKE IMAGE
            val bitmap = getBitmapFromVectorDrawable(
                this,
                R.drawable.sample_bill_gates,
                100,
                100
            )
            onChoseImage(bitmap)
    ...
    private fun onChoseImage(bitmap: Bitmap) {
        ...
        //TODO use real picture //Get it from camera
